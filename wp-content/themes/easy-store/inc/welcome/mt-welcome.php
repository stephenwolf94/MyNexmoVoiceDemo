...
<?php
    ...
    public function easy_store_admin_footer_text( $text ) {
        ...
        if ( 'appearance_page_easy-store-welcome' == $screen->id ) {
            ...
            $text = sprintf( __( 'If you like <strong>%1$s</strong> please leave us a %2$s rating. A huge thank you from <strong>Mystery Themes</strong> in advance!', 'easy-store' ), esc_html( $theme_name ), '<a href="https://wordpress.org/support/theme/easy-store/reviews/?filter=5" class="theme-rating" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a>' );
